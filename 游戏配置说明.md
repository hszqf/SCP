...
## 1. 配置文件位置与加载
- 主配置文件：Assets/StreamingAssets/game_data.json
...
| 字段 | 类型 | 含义 | 备注 |
| --- | --- | --- | --- |
| nodeId | string | 节点 ID | 建议 N1、N2… |
| name | string | 节点名称 | UI 显示 |
| startPopulation | int | 初始人口 | 影响收入 |
| unlocked | int | 是否初始解锁 | 1=解锁，0=锁定 |
